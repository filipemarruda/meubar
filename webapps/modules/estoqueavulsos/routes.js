...
var estoqueAvulsosApp = angular.module('estoqueavulsos');

estoqueAvulsosApp.config(function($stateProvider, $urlRouterProvider) {
	
	var moduleConfig = new ModuleConfig(estoqueAvulsosApp.name);
