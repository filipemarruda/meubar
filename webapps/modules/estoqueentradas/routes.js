...
var estoqueEntradasApp = angular.module('estoqueentradas');

estoqueEntradasApp.config(function($stateProvider, $urlRouterProvider) {
	
	var moduleConfig = new ModuleConfig(estoqueEntradasApp.name);
