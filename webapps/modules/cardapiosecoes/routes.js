...
var cardapiosecoesApp = angular.module('cardapiosecoes');

cardapiosecoesApp.config(function($stateProvider, $urlRouterProvider) {
    
  var moduleConfig = new ModuleConfig(cardapiosecoesApp.name);
