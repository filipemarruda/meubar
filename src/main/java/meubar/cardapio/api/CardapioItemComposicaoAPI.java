...
import meubar.cardapio.servico.ServicoCardapioItemComposicao;
import meubar.json.pojo.Messagem;

import com.google.gson.Gson;

@Path("/cardapiocomposicao")
@Produces(MediaType.APPLICATION_JSON)
public class CardapioItemComposicaoAPI extends BaseAPIImpl {

	@EJB
	ServicoCardapioItemComposicao servico;

	public CardapioItemComposicaoAPI() {
	}
	...
	public Response doGet(@CookieParam("auth_token") String token) {
		...
		String result = null;
		Gson gson = new Gson();
		List<CardapioItemComposicaoJson> list;
	...
	public Response doGet(@CookieParam("auth_token") String token, @PathParam("id") String id) {
		...
		try {
			...
			CardapioItemComposicaoJson item = servico.getById(id);
	...
	public Response doPost(@CookieParam("auth_token") String token, String json) {
		...
		try {
			...
			CardapioItemComposicaoJson itemJson = gson.fromJson(json, CardapioItemComposicaoJson.class);
